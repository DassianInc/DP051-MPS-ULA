Ext.define('Gnt.examples.advanced.view.Gantt', {
    ...
    columns : {
        // Ext JS 5 bug, not reproducible in 6.0
        // http://bryntum.com/forum/viewtopic.php?f=9&p=37515#p37515
        enableFocusableContainer : false,
        onHeaderActivate : function(e) {
            var column = this.getFocusableFromEvent(e);

            if (column && column instanceof Ext.grid.Column) {
                return Ext.grid.header.Container.prototype.onHeaderActivate.apply(this, arguments);
            }
        },
        items : [
            {
